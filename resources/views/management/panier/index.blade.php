                    ...
                    <div class="card shadow mb-4" style="background-color: #f5f5f5">
                        @if ($listC->isEmpty())
                            <div class="card-body text-center" style="background-color: #f5f5f5">
                                ...
                                <a href="{{ route('index') }}">
                                    <button type="button"
                                        class="rounded-pill btn btn-outline-primary btn-rounded mt-3 mb-3">
                                        Parcourir les cours
                                    </button>
                                </a>
                            </div>
                                    ...
                                    <div class="row no-gutters">
                                                    ...
                                                    @if ($item->price != 0.0)
                                                        <div style="background-color: #ffffff"
                                                            ...
                                                            <div class="d-flex flex-row">
                                                                <div
                                                                    class="custom-control custom-checkbox align-self-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="payment-info mt-5 shadow" style="background-color: #ffffff">
                                                ...
                                                <button href="#myModal" data-toggle="modal" id="pay"
                                                    style="background-color: #7B66FF;color:#fff;"
                                                    class="btn  btn-block d-flex justify-content-center mt-3" type="button"
                                                    disabled>
                                                    <span>pay</span>
                                                </button>
                                            </div>
                                            <div class="payment-info mt-3 shadow" style="background-color: #ffffff">
                                                <div class="cart-icons">
                                                    <div class="cart-icons-title mb-2" style="color: black;">Payez avec
                                                    </div>
                                                    <div class="cart-icons-list mt-1 mb-1">
                                                        ...
                                                        <i style="color: #000000;"
                                                            class="fa-brands fa-cc-paypal fa-2xl"></i>
                                                        <i style="color: #000000;"
                                                            class="fa-brands fa-google-pay fa-2xl"></i>
                                                        <i style="color: #000000;"
                                                    ...
                                                    <div class="cart-icons-list mt-1 fw-light" style="color: black;">
                                                        ...
                                                        <img src="{{ asset('storage/images/insurance.png') }}"
                                                            height="21" {{-- style="vertical-align: middle; " --}}>&nbsp;&nbsp;Obtenez un
