                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800" id="consommer">{{ $consommer }}</div>
                            </div>
                            <div class="col-auto">
                                <i class="fa-solid fa-paste fa-2x text-gray-300"></i>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800" id="coursV">{{ $coursV }}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800" id="coursNo">{{ $coursNo }}</div>
                            </div>
                            <div class="col-auto">
